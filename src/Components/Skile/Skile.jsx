...
const Skile = () => {
    return (
      ...
      <div className="max-w-6xl mx-auto px-6">
        <h2 className="text-5xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-emerald-500 to-indigo-500"> MY Skills</h2>
        <div className="mt-6 grid grid-cols-2 md:grid-cols-5 gap-6">
            {/* img-1 */}
          < motion.div className="p-4  h-48 w-48 space-y-2 rounded-2xl shadow bg-gray-700"
...
>
            ...
            {/* img-2 */}
          <motion.div className="p-4  h-48 w-48 space-y-2 rounded-xl bg-gray-700 shadow"
          whileHover={{ scale: 1.2 }}
            whileTap={{ scale: 0.8 }}
          >
             <div className='flex justify-center items-center'>
          ...
          >
            ...
            {/* img-5 */}
          <motion.div className="p-4 h-48 w-48  rounded-xl bg-gray-700 shadow"
           whileHover={{ scale: 1.2 }}
            whileTap={{ scale: 0.8 }}
          >
             <div className='flex justify-center items-center '>
